...
public class SecondFragment extends Fragment{
    ...
    private List<SecondInnerFragment> pagerItems = new ArrayList<>();
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 0; i <= 10; i++) {
            pagerItems.add(new SecondInnerFragment(new ViewPagerItem("Fragment 编号" + i)));
        }
        pagerAdapter = new SecondViewPagerAdapter(getActivity().getSupportFragmentManager());
